...
public class TokenizerFunction {
    ...
    /**
     * Function that tokenizes words from an Element.
     * Splits the preprocessed value of the Element into tokens using whitespace and commas as delimiters.
     * Creates a stream of Token objects, each representing a token along with the Element it belongs to.
     *
     * @return A function that takes an Element as input and returns a stream of tokens.
     */
    public static Function<Element, Stream<Token>> wordsTokenizer() {
        return element -> {
            String str = (String) element.getPreProcessedValue();
