...
public class PreProcessFunction<T>{
    ...
    /**
     * Function that preprocesses words in a list of strings.
     * Converts words to lowercase, removes leading and trailing whitespace,
     * and removes any characters that are not lowercase letters.
     *
     * @return A function that takes an array of strings as input and returns a single string
     *         containing the preprocessed words separated by commas.
     */
    public static Function<String[], String> wordsPreProcessing() {
        return (strings) -> {
            ...
            for (String str : strings) {
                ...
                processedString.append(str).append(",");
            }
            return processedString.length() > 0 ? processedString.substring(0, processedString.length() - 1) : "";
        };
    }
